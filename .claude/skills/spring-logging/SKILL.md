---
name: spring-logging
description: Logging conventions for keycloak-user-storage — Lombok @Slf4j, no System.out, warn/error for business issues, debug for detail. Use in /build and /review.
---
# Logging

Ported from the former `.claude/conventions/02`.
